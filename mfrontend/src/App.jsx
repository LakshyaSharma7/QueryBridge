...
import EditTable from './pages/EditTable.jsx'; // New import
import './App.css';
        ...
        <div className="main-layout">
          ...
          <main className="main-content">
            <Routes>
              ...
              <Route path="/view-table/:tableName" element={<ViewTable />} /> {/* New route */}
              <Route path="/edit-table/:tableName" element={<EditTable />} /> {/* New route */}
